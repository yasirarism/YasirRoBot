...
async def follow_user(b, m):
    try:
        ...
        await b.send_message(chat_id=m.chat.id, text="<B>HERE'S THE FOLLOW LINK</B>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Follow Me", url=f"https://t.me/YasirPediaChannel")]]), disable_web_page_preview=True)
